...
const SLIDES = [
  {
    image: "/images/black_oversized_tee_street_style_1770113164208.png",
    ...
    <section className="relative min-h-[85vh] sm:min-h-[80vh] lg:min-h-[90vh] pt-8 sm:pt-12 lg:pt-16 flex items-center overflow-hidden bg-gradient-to-br from-background via-background to-muted pb-16 lg:pb-0">
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Slider Column - First on mobile, second on desktop */}
          <div className="relative group order-1 lg:order-2">
            ...
            {/* Navigation Arrows - Better positioned to avoid overlap */}
          ...
          >
            <div className="space-y-4">
              ...
              >
                Express yourself with premium streetwear that speaks your language.
